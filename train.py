...
def parse_opt(known=False):
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/SeaDronesSee.yaml', help='dataset.yaml path')
    ...
    parser.add_argument('--cache', type=str, nargs='?', const='ram', default=False,help='image --cache ram/disk')
